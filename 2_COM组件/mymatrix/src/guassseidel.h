...
#ifndef __guassseidel_h
#define __guassseidel_h 1
...
extern void InitializeModule_guassseidel(void);
extern void TerminateModule_guassseidel(void);
extern _mexLocalFunctionTable _local_function_table_guassseidel;
