...
extern void InitializeModule_myminus(void);
extern void TerminateModule_myminus(void);
extern _mexLocalFunctionTable _local_function_table_myminus;
