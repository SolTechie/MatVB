...
extern void InitializeModule_mypascal(void);
extern void TerminateModule_mypascal(void);
extern _mexLocalFunctionTable _local_function_table_mypascal;
