...
extern void InitializeModule_mysolve(void);
extern void TerminateModule_mysolve(void);
extern _mexLocalFunctionTable _local_function_table_mysolve;
