...
#ifndef __mymultiply_h
#define __mymultiply_h 1
...
extern void InitializeModule_mymultiply(void);
extern void TerminateModule_mymultiply(void);
extern _mexLocalFunctionTable _local_function_table_mymultiply;
