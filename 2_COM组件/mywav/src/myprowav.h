...
extern void InitializeModule_myprowav(void);
extern void TerminateModule_myprowav(void);
extern _mexLocalFunctionTable _local_function_table_myprowav;
